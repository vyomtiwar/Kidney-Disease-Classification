...
```bash
https://github.com/vyomtiwar/Kidney-Disease-Classification.git
```
...
MLFLOW_TRACKING_URI="Your DagsHub's Repository URI"
MLFLOW_TRACKING_USERNAME="Your DagsHub's UserName"
MLFLOW_TRACKING_PASSWORD="Your DagsHub's Password"
python script.py
...
export MLFLOW_TRACKING_URI=Your DagsHub's Repository URI

export MLFLOW_TRACKING_USERNAME=Your DagsHub's UserName
